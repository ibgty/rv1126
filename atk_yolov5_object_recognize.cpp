...
#include "atk_yolov5_object_recognize.h"
  ...
  FPSContext fps_ctx{0,0};
  PerformanceMonitor thread_statistic;
...
void *rkmedia_rknn_thread(void *args)
{
 ...
 thread_statistic.begin(Stage::IM_PREPROCESS);
    ...
    */
    ...
    rga_resize(&rga_ctx, -1, input_data, video_width, video_height, inputs_mem[0]->fd, nullptr, width, height);
